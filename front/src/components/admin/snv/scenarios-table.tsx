                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => navigator.clipboard.writeText(scenario.description)}>
                                Copier description
                            </DropdownMenuItem>
                            <DropdownMenuSeparator />
...
export function SNVScenariosTable({ data, onEdit, onDelete }: SNVScenariosTableProps) {
