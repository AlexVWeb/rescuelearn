...
import { createScenarioAction, updateScenarioAction, SNVScenario } from "@/app/actions/snv-actions";
...
export function SNVScenarioDialog({ open, onOpenChange, scenario }: SNVScenarioDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    <DialogTitle>{scenario ? "Modifier le scénario" : "Créer un scénario"}</DialogTitle>
                    <DialogDescription>
