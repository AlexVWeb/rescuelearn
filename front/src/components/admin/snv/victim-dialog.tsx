...
import { createVictimAction, updateVictimAction, SNVVictim, getAllScenariosSimpleAction } from "@/app/actions/snv-actions";
...
export function SNVVictimDialog({ open, onOpenChange, victim }: SNVVictimDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    <DialogTitle>{victim ? "Modifier la victime" : "Créer une victime"}</DialogTitle>
                    <DialogDescription>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="0" className="text-green-600 font-medium">Vert (Urgence Relative)</SelectItem>
                                            <SelectItem value="1" className="text-yellow-600 font-medium">Jaune (Urgence Relative)</SelectItem>
                                            <SelectItem value="2" className="text-red-600 font-medium">Rouge (Urgence Absolue)</SelectItem>
                                            <SelectItem value="3" className="text-black font-medium">Noir (Décédé)</SelectItem>
                                        </SelectContent>
                                    </Select>
                                    <FormMessage />
                                </FormItem>
