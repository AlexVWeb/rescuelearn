...
export const columns = (
    ...
    onDelete: (id: number) => void
        ...
        },
        {
            ...
            header: "Temps/Q (sec)",
            cell: ({ row }) => <div className="text-center">{row.getValue("timePerQuestion")}</div>,
        },
        {
            accessorKey: "passingScore",
            header: "Score (%)",
            cell: ({ row }) => <div className="text-center">{row.getValue("passingScore")}%</div>,
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex justify-center">
                        {isRandom ? <Check className="h-4 w-4 text-green-500" /> : <X className="h-4 w-4 text-red-500" />}
                    </div>
                )
            },
        },
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => onDelete(quiz.id)} className="text-destructive">
                                Supprimer
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
