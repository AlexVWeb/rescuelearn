...
import { createReferencielAction, updateReferencielAction, Referenciel } from "@/app/actions/referenciel-actions";
...
export function ReferencielDialog({ open, onOpenChange, referenciel }: ReferencielDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle>{referenciel ? "Modifier le référentiel" : "Nouveau référentiel"}</DialogTitle>
                    <DialogDescription>
                        {referenciel
