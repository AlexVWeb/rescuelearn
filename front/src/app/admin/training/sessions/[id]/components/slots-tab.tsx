...
export function SlotsTab({ sessionId, slots }: SlotsTabProps) {
  ...
  async function handleAddSlot() {
    if (!newSlot.label || !newSlot.date || !newSlot.startTime || !newSlot.endTime) return;
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Définissez les créneaux horaires (slots) de cette session pour l'émargement.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-2 mb-6 items-end">
            ...
            <Button onClick={handleAddSlot} disabled={loading} className="w-full sm:w-auto">
